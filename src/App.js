...
import projectsData from "./podcasts.json";
      ...
      <ThemeProvider theme={appliedTheme}>
        ...
        <div className={classes.wrapper}>
          ...
          <Typography
            ...
            color="primary"
          >
            Podcasts that I'm currently working or worked before (click <a href="https://jpromanonet.vercel.app">here</a> to return home)
          </Typography>
          <Typography
            variant="h5"
            className={classes.littleSpace}
          ...
          >
            <div className={classes.navBar}>
              ...
              <Typography variant="subtitle1" color="primary">
                {filteredProjects.length} {selectedCategory === "All" ? "Total podcasts" : "podcasts in " + selectedCategory}
              </Typography>
            </div>
          </Typography>
        </div>
